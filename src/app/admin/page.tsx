          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Add, edit, and remove manager accounts</p>
              </div>
            </div>
            <Button className="mt-4 w-full" variant="outline" onClick={() => router.push('/admin/manage-managers')}>
              Manage Managers
            </Button>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">View all properties in the system</p>
              </div>
            </div>
